  ...
  function ProductActions({ product }) {
    ...
    return (
      <button
        ...
        ${
          inWishlist
            ? "bg-[#c2ab72] text-white border-[#c2ab72]"
            : "bg-white text-[#c2ab72] border-[#c2ab72]"
        }`}
      >
            ...
            <table className="w-full text-[1.09rem] font-medium">
              <tbody>
                {highlights.map((h, idx) => (
                  ...
                  >
                    <td
                      className="pr-3 py-3 text-[#7f7755] w-56"
...
//  */
// export default async function ProductPage({ params }) {
//   const rawId = params?.id; // string from URL

//   if (!rawId) {
//     throw new Error("Invalid product id");
//   }

//   // Prisma Watch.id is String, so use rawId directly
//   const product = await prisma.watch.findUnique({
//     where: { id: rawId },
//   });
